# -*- coding: utf-8 -*-
# Generated by Django 1.9.13 on 2017-09-10 17:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startTime', models.DateTimeField(default=False, null=True, verbose_name='\u5f00\u59cb\u65f6\u95f4')),
                ('endTime', models.DateTimeField(default=False, null=True, verbose_name='\u7ed3\u675f\u65f6\u95f4')),
                ...
                ('tagId', models.IntegerField(default=False, null=True, verbose_name='\u6807\u7b7eId')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stepInstance_id', models.IntegerField(null=True, verbose_name='\u6267\u884c\u4f5c\u4e1a\u5b9e\u4f8b\u6b65\u9aa4id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ipListId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job.Nm_ipList', verbose_name='\u76ee\u6807\u673a\u5668\u7684ip')),
                ('taskInstanceId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job.Nm_Instance', verbose_name='\u6267\u884c\u4f5c\u4e1a\u5b9e\u4f8bid')),
            ],
            options={
